This markdown is generated from [the source](main.cpp) when it compiles successfully.

# References
- [Modern CPP features](https://github.com/AnthonyCalandra/modern-cpp-features/blob/master/README.md)
